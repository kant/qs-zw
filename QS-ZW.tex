...
contrasted it with that of the Northern Hemisphere using the NCEP/NCAR
reanalysis from 1948 to 2017. We also devised a quantitative measure of
planetary wave stationarity and applied it to both hemispheres. We
confirm that in the SH planetary wave 1 is highly stationary. However,
we show that planetary waves 2 and 3 have a comparable mixture of
...
variations could help to better understand the variability in the
