...
(1957-1958) before the advent of modern reanalysis datasets. In this
study, we assessed the stationary conditions in the SH and contrasted it
with that of the Northern Hemisphere using the NCEP/NCAR reanalysis from
1948 to 2017. We also devised a quantitative measure of planetary-wave
stationarity and applied it to both hemispheres. We confirm that in the
SH planetary wave 1 is highly stationary. However, planetary waves 2 and
3 have a comparable mixture of stationary and moving components with
significant variability from interseasonal and decadal timescales. A
deeper knowledge of those variations could help in the future to better
understand the variability in the responses of mid-latitudes atmospheric
circulation to surface forcing caused either by its strength or the
