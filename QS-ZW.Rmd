...
abstract: >
  Most studies of quasi stationary planetary waves have assumed the quasi stationary nature of southern hemisphere planetary waves based on @Loon1972, which was based on only 2 years of data before the advent of modern reanalysis. In this study, we devised a quantitative measure of planetary wave stationarity and applied it to both hemispheres using the NCEP Reanalyss [@Kalnay1996]. We show that in the southern hemisphere planetary wave 1 is highly stationary while planetary waves 2 and 3 have a comparable mixture of starionary and moving components with significant decadal variability. These variations can be used to study variability in surface forcing responses caused either by the strength of the forcing or the sensitivity of mean state of the atmosphere.
...
```{r s-timeseries, fig.cap = "Quasi-stationary wave stationarity for wavenumbers 1 to 3 at 50\\degree S and 500hPa for the NCEP Reanalysis and ERA-20C.", fig.width=5, fig.height=4}
pw <- data %>%
