...
abstract: "Many studies of quasi stationary planetary waves in the Southern Hemisphere assumed their quasi stationary nature based on @vanloon1972. However, that study is based on only 2 years of data (1957-1958) before the advent of modern reanalysis datasets. In this study, we assessed the stationary conditions in the SH and contrasted it with that of the Northern Hemisphere using NCEP/NCAR reanalysis. We also devised a quantitative measure of planetary wave stationarity and applied it to both hemispheres. We confirm that in the SH planetary wave 1 is highly stationary. But we also show that planetary waves 2 and 3 have a comparable mixture of stationary and moving components with significant decadal variability. The knowledge of those variations could be useful to better understand the variability in the responses to surface forcing caused either by the strength of the forcing or the sensitivity of the atmosphere to the forcing"
...
$\hat{S}$ is considered in some studies as $2/\pi\arcsin \left (\hat{S} \right )$ [e.g. @singer1967] for analyzing wind steadiness [e.g. @hiscox2010]. To our knowledge this is the first time that this approach is applied to study atmospheric waves.
...
Finally, the fact that planetary wave stationarity exhibits interannual and decadal variability, could be useful to study variability in surface forcing responses caused either by the strength of the forcing or the sensitivity of mean state of the atmosphere
