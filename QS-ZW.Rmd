...
```{r s-timeseries, fig.cap = "Quasi-stationary wave stationarity for wavenumbers 1 to 3 at 50\\degree S and 500hPa.", fig.width=5}
pw <- data %>%
...
pw %>% 
  ...
  facet_grid(dataset~lat,labeller = labeller(lat = LatLabel),
             as.table = FALSE)
```
