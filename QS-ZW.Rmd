...
output:
   ...
   word_document:
      default
bibliography: "qszw-pkgs.bib,qszw.bib"
header-includes: 
      - \usepackage{gensymb} 
      - \usepackage{soulutf8}
      - \usepackage{subfig}
...
We analyzed the data using the statistical programming language R [@R-base], using metR [@R-metR] and data.table [@R-data.table] packages to read and transform it, and ggplot2 package [@R-ggplot2] to plot it. The source code is available as Figshare repository [@Campitelli2019-figshare].
